...
| File | For |
| --- | --- |
| [claude-usage-widget_0.1.0_x64-setup.exe](../../releases/download/v0.1.0/claude-usage-widget_0.1.0_x64-setup.exe) | 64-bit Windows |
| [claude-usage-widget_0.1.0_x86-setup.exe](../../releases/download/v0.1.0/claude-usage-widget_0.1.0_x86-setup.exe) | 32-bit Windows |
