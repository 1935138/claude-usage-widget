...
| File | For |
| --- | --- |
| [claude-usage-widget_0.1.7_x64-setup.exe](../../releases/download/v0.1.7/claude-usage-widget_0.1.7_x64-setup.exe) | 64-bit Windows |
| [claude-usage-widget_0.1.7_x86-setup.exe](../../releases/download/v0.1.7/claude-usage-widget_0.1.7_x86-setup.exe) | 32-bit Windows |
...
This is the last version you have to install by hand: from here the widget can
see a new release and install it itself, from the settings panel.
